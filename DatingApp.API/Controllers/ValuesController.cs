...
{
    [Authorize] // requires authorization if want to access these controller
    [Route("api/[controller]")]
    [ApiController]
    public class ValuesController : ControllerBase //ControllerBase : M C no View , Controller : MVC 
    {
